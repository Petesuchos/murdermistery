...
locais = ["rua", "jardim", "garagem", "sala de estar", "quarto", "cozinha", "escritório", "biblioteca", "parque", "mercado", "posto de gasolina", "escadaria", "Congresso Nacional", "pista de skate", "academia", "padaria", "relojoaria", "banco", "zoológico", "sala de aula", "escola", "lago", "casa do Patolino", "borracharia", "tribunal", "laboratório", "pula pula", "bar", "boliche", "show"]
horas = ["14:00", "18:30", "22:15", "07:45", "16:50", "12:10", "23:30", "09:00", "03:45", "11:15", "8 da manhã", "10 horas mais ou menos", "23:55", "22 em ponto"]
eventos = ["um assalto", "uma briga", "um furto", "um arrombamento", "um sequestro", "um disparo de arma", "um roubo", "um corre corre", "um vandalismo", "um ato suspeito", "um grito", "um poltergeist", "uma assombração", "uma facada", "uma briga", "uma cusparada", "um xingamento", "um tapa", "uma violação das liberdades individuais", "um ovni", "uma criança chorando", "um gato miando", "um crime ambiental", "um cachorro latindo", "uma flechada", "uma batida", "um ataque de ganso"]
objetos = ["uma bolsa", "um telefone", "uma carteira", "um notebook", "uma chave", "um livro", "um documento", "um casaco", "uma mochila", "um relógio", "uma arma", "uma chave inglesa", "uma soqueira", "uma fantasia", "uma máscara", "uma criatura", "um dente", "uma Bíblia", "um computador", "um robô", "uma pistola", "um machado", "um envelope", "um cadáver"]
atividades = ["conversando", "lendo", "trabalhando", "cozinhando", "correndo", "andando", "esperando", "observando", "procurando algo", "descansando", "orando", "latindo", "mordendo", "gritando", "batendo", "girando", "dançando", "mascando chiclete", "dormindo", "pedalando", "cantando", "roncando", "sonhando", "roubando um pirulito de criancinha"]
cores = ["vermelho", "azul", "verde", "amarelo", "preto", "branco", "cinza", "marrom", "roxo", "laranja", "cor de rosa", "cor de burro quando foge", "laranja", "multicolorido", "cerúleo"]
veiculos = ["carro", "moto", "bicicleta", "caminhão", "van", "ônibus", "táxi", "triciclo", "patinete", "caminhão", "carroça", "trenó", "mobilete", "balão"]
animais = ["cachorro", "gato", "papagiao", "cavalo", "coelho", "rato", "tartaruga", "cobra", "hamster", "lontra", "capivara", "urso", "lobo", "omça", "tucano", "formiga", "cobra", "pato", "ganso", "ganso violento"]
comidas = ["sanduíche", "maçã", "pizza", "café", "bolo", "salada", "sopa", "suco", "chá", "biscoito", "hamburguer", "sushi", "poke", "lamen", "pão", "gelatina", "um pirulito"]
reacoes = ["Fiquei assustado", "Fiquei nervoso", "Não soube o que fazer", "Corri para o outro lado", "Chamei a polícia", "Me escondi", "Tentei ajudar", "Fiquei em choque", "Observei à distância", "Fiquei paralisado", "Fingi que não era comigo", "Liguei pros bombeiros", "Resolvi tirar a carteira de trabalho", "Corri pra igreja", "Parei de beber", "Acordei para a vida", "Fiquei de boa", "Achei estranho", "Achei normal", "Larguei meu trabalho", "Tirei foto para postar na internet", "Tirei uma selfie", "Gravei um vídeo para o Tiktok", "Cancelei minha redes sociais"]
coisas_inusitadas = ["um bilhete", "uma foto", "uma luva", "um sapato", "uma corda", "um chapéu", "uma máscara", "um guarda-chuva", "um vidro quebrado", "um pedaço de tecido", "um ovni", "um mascote de gato", "um pato de verdade", "uma sapatilha", "um tabuleiro de Banco Imobiliário", "um par de patins", "uma caixa de som", "uma peruca"]
comentarios = ["Não parecia algo comum", "Me deixou muito preocupado", "Nunca vi algo assim antes", "Não fazia sentido", "Era algo estranho", "Me fez pensar no pior", "Foi difícil de acreditar", "parecia suspeito", "Me causou calafrios", "Não sei o que estava acontecendo", "Me fez voltar pra igreja", "Mudei de voto", "Me benzi", "Só Jesus na causa", "Uma maluquice", "É de deixar o cidadão de bem indignado", "Sem noção", "Vai trabalhar", "Quem sou eu pra julgar", "Vai que dá certo", "É o novo normal", "Tem gente que acha bonito", "Parei de beber", "Fiquei emocionado", "Desmaiei"]
pessoas = ["um suspeito", "uma figura estranha", "um maluco", "um homem", "uma mulher", "um bandido", "um ladrão", "um juiz suspeito", "um careca", "uma doida", "um doido", "um feiticeiro", "uma feiticeira", "um transeunte", "um policial", "um palhaço", "um político", "um deputado"]
